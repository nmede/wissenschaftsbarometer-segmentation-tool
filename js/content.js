/* =====================================================================
   ...
   Wording taken verbatim from the official Wissenschaftsbarometer
   Schweiz 2022 CATI questionnaires (Universität Zürich).
   Only the 20 items required for the segmentation are included, plus
   age, gender and education. The scale endpoints and "don't know"
   option match the CATI instrument.
   ===================================================================== */
