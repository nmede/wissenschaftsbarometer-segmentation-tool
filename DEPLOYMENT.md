...
When a new version adds database fields (e.g. the canton question and the
age/education/canton dashboard breakdowns), simply **re-run the current
`supabase/schema.sql`** in the SQL editor. The script is idempotent: it adds
