...
A multilingual (DE / FR / IT) online questionnaire that places each respondent
...
1. **Sciencephiles** — strongly interested, informed, high trust
2. **Critically Interested** — interested but with critical distance
3. **Passive Supporters** — broadly favourable but not actively involved
4. **Disengaged** — little interest in or closeness to science
...
This online version asks the **20 segmentation items plus birth year, gender,
education and canton**, grouped on 7 thematic pages with horizontal scales. It deliberately omits the many other questions from the full 20-minute
