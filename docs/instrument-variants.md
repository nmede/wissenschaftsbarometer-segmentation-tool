...
**Status: the 10-item short form is ACTIVE** (validated against the
published supplement: coefficients digit-identical; development sample
reproduced 1051/1051, probabilities to <2e-15; 2022 out-of-wave agreement
with the 20-item instrument: 84.5%, all disagreements between adjacent
segments). The 1-item screener remains pending official DE/FR/IT wordings.
 — implementation notes (feature on hold)
